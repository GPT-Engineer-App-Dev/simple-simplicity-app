...
**Project**: simple-simplicity-app 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Make the simplest app possible 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/simple-simplicity-app.git
cd simple-simplicity-app
npm i
